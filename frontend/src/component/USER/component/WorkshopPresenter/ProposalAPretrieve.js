...
export default class UNProposal extends Component {
  ...
  handleSearchArea = (e) => {
    ...
    axios.get(`http://localhost:5050/proposal/specproposalap/${decode.email}`).then((res) => {
      if (res.data.success) {
  ...
  render() {
    return (
      ...
      <div style={{ marginTop: "3rem" }}>
        ...
        <div class="d-flex">
          <div class="mr-auto p-2"> <h4 style={{fontWeight:"bold"}}>Approved Proposals</h4></div>
          <div class="p-2"><input
        ...
        <table className="table">
          ...
          <MDBCardBody className='elegant-color white-text rounded-bottom'>
            ...
            <MDBCardTitle>Approved Proposal</MDBCardTitle>
            <hr className='hr-light' />
            <br/>
            <div className="row"><center>
            <p className="h1" style={{marginLeft:"6rem",fontSize:"3rem"}}> <b>{this.state.proposal.length}</b></p>
            </center>
              </div>
          </MDBCardBody>
        </MDBCard>
