...
import UserApprovedPaid from "./UserApprovedPaidPaper";
import UserApprovedNotPaid from "./UserApprovedNotPaidPaper";
class AllApproves extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
export default withRouter(AllApproves);
